 ...
 * Generated for Laravel 5.2.45 on 2018-08-30 15:53:27.
 *
...
namespace App\Services\Common\Facades { 
    ...
    class AjaxResponse {
        ...
        {
            return \App\Services\Common\AjaxResponse::getMsg($code);
        }
         ...
         * @static 
         */ 
        public static function success($anyInfo, $hasResponse = true, $jsonpCallback = '')
        {
            return \App\Services\Common\AjaxResponse::success($anyInfo, $hasResponse, $jsonpCallback);
        }
         ...
         * @static 
         */ 
        public static function fail($anyInfo, $hasResponse = true, $jsonpCallback = '', $errCode = 0)
        {
            return \App\Services\Common\AjaxResponse::fail($anyInfo, $hasResponse, $jsonpCallback, $errCode);
        }
         ...
         * @static 
         */ 
        public static function loginValidationFail()
        {
            return \App\Services\Common\AjaxResponse::loginValidationFail();
        }
